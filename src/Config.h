...
// Provisional — reasoned estimates, not yet measured against this board's
// real ADC noise floor. Retune if the charging bolt flickers on/off (too
// tight) or never triggers despite visibly charging (too loose).
